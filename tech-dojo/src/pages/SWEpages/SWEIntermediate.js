...
import "./SWEIntermediate.css"; // Ensure this is a separate CSS file for Intermediate

const SWEIntermediate = () => {
  ...
  const lessons = [
    { id: "whatisSWE", title: "What is SWE", link: "/learning/swe/intermediate/what", icon: "⭐", position: "left" },
    { id: "revision", title: "Revision", link: "/learning/swe/intermediate/revision", icon: "❓", position: "right" },
    { id: "safety", title: "Software Safety", link: "/learning/swe/intermediate/safety", icon: "⭐", position: "left" },
    { id: "api", title: "API Development", link: "/learning/swe/intermediate/api", icon: "⭐", position: "right" },
    { id: "project", title: "Final Project", link: "/learning/swe/intermediate/project", icon: "🛠️", position: "left" }, // 🔹 Project Emoji
  ];
  ...
  return (
    <div className="ai-intermediate-container">
      <h1 className="intermediate-title">Intermediate SWE Roadmap</h1>
...
export default SWEIntermediate;
